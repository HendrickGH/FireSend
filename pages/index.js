              ...
              <div className="lg:flex md:shadow-lg p-5 bg-white rounded-lg py-10">
                  ...
                  <div className="md:flex-1 mb-3 mx-2 mt-16 lg:mt-0">
                      ...
                      <p className="text-lg leading-loose">
                        <span className="text-red-500 font-bold">Fire Send</span> te permite compartir archivos con cifrado de extremo a extremo y un archivo que es eliminado después de ser descargado. Así que puedes mantener lo que compartes en privado y asegurarte de que tus cosas no permanezcan en línea para siempre.
                      </p>
